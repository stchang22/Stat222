...
This first tree represents the comparison of the two lowest leagues.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_22_0.png}
    \par
    \end{center}
...
league.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_26_0.png}
    \par
    \end{center}
...
For the final tree, we compare the two highest leagues.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_28_0.png}
    \par
    \end{center}
...
that lists the three most important variable used by the trees.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_30_0.png}
    \par
    \end{center}
...
then for this result to show up in the following KNN decision plots.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_35_0.png}
    \par
    \end{center}
...
This next plot is made to contrast the one from before.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_38_0.png}
    \par
    \end{center}
...
the player's current league.
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{MergedFile_files/MergedFile_46_0.png}
    \par
    \end{center}
